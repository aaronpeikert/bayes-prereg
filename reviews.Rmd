...
Reducing uncertainty about its theoretical risk is still useful for scientific progress, in order for us to be better able to judge its theoretical risk (for example, the theoretical risk may low but higher than another exploratory study).
