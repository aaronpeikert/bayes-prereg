...
A frequentist (and hence severe tester), can not possibly assign a probability here because there is no random process but a single event that happened in the past, so the paper was either p hacked or not.
This is similar to the mistake, in frequentist philosophy, to say that an effect is with 95% probability in the confidence interval.
