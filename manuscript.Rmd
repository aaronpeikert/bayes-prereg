...
As we further argued, minimizing the uncertainty about theoretical risk is similarly beneficial without increasing the likelihood of a "failed" study.
...
Under the current incentive structure in academia, however, many researchers have reason to avoid such negative outcomes and few, if any, have the privilege to operate outside of these incentives. <!--AB: but see registered reports, journals that increasingly publish null findings, Bayesian analyses etc-->
