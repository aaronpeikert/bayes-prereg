...
#| fig.cap: "Posterior Probability (corroboration as firmness) as a function of $\tau$, where $\tau$ is either certain (solid line) or maximally uncertain (dotted line)."
...
```{r, dev = "tikz", cache=TRUE, warning=FALSE}
#| fig.cap: "Several measures for corroboration as increase in firmness as a function of $\tau$, where $\tau$ is either certain (solid line) or maximally uncertain (dotted line)."
