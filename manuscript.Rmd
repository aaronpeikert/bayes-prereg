...
In reality, surely researchers differ in what function they apply to judge evidence.
...
However, we latter discuss why detectability can not be disregarded from consideration.
...
We note these relations to underline that the Bayesian rationale we apply here is able to reconstruct many commonly held views on riskiness and epistemic value (but Popper would disagree with attaching any form of believe in $H$ on the basis of evidence).
