...
Skeptics question why a study should be preregistered at all.
Even researchers convinced of the advantages have some problems when left with nothing more than an intuitive appeal.
Their intuition must answer difficult questions, such as what to include, in how much detail, in the preregistration, or what conditions warrant deviating from the preregistration.
If the research community remains confused about the purpose of preregistrations, it is bound to misapply it and hence decrease the efficiency of the scientific endeavour. 
...
Insisting on equating preregistration and confirmation has led to criticism that preregistration is actually negative sum, and neither sufficent nor neccesary to establish confirmation [@szollosiPreregistrationWorthwhile2020; @phamPreregistrationNeitherSufficient2021]
