...
Second, there is strict mapping of the categories preregistered vs. non-preregistered onto the categories confirmatory vs. exploratory research.
...
We argue that this view on the utility of preregistration can be interpreted as maximizing theoretical risk, which is reduced by researchers' degrees of freedom, p-hacking, and suchlike.
...
The second option is similarly commonsensical; that is, an increase in $P(E|H)$ leads to a higher posterior probability $P(H|E)$.
