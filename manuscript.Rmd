...
To better understand how preregistrations can achieve that, let us take a closer look at what factors contribute to $P(E)$. <!--AB: is this expectedness (Pap, 1962) as quoted on p.818 in Meehl's risk paper?-->
...
For the purpose of illustration, we define it somewhat hand-wavinlyg as an cognitive abstraction that allows agents to consistently solve a well-defined class of problems.
