...
#| fig.cap: "\\label{fig:posterior}Posterior Probability (corroboration as firmness) as a function of $\\tau$, where $\\tau$ is either certain (solid line) or maximally uncertain (dotted line)."
