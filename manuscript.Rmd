...
Many researchers preregister their studies [@nosekPreregistrationRevolution2018] to honour this distinction and produce results that are considered confirmatory.
...
Those without this intuition ask the fundamental question of why should a study be preregistered at all?
Nevertheless, even researchers convinced of its advantages have some problems with an intuitive approach.
Before data collection, they must make difficult decisions about what to include in the preregistration and in how much detail.
After data collection, they might be uncertain what conditions warrant deviating from the preregistration.
If the research community remains confused by the purpose of preregistrations, it decreases the efficiency of the scientific endeavour. 
We propose a principled justification for preregistration with a formal objective against which researcher can evaluate their trade-offs.

Preregistrations trade-off researchers' degrees of freedom (XXX) to obtain more confirmatory results.
However, balancing this trade-off is difficult.
Being too restricted by the boundaries set in the preregistration make some researchers hesitant to adopt the practice [@goldin-meadowWhyPreregistrationMakes2016].
...
The conundrum is that the current conceptualization of preregistration deems a study "properly" preregistered even if it contains a recipe for p-hacking before data collection but "improper" if the researcher did technically deviate afterwards.
