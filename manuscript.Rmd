...
keywords: |
  preregistration; confirmatory analyses; exploratory analyses; hypothesis testing; bayesian; open science
header-includes: |
  \usepackage{hyperref}
...
They do so to stress the predictive nature of their registered statistical analyses and often with the hopes of obtaining a label that marks the study as "confirmatory".
...
2. They try to maximize the expected epistemic value for other researchers.
...
We have proposed a highly specific, yet practical preregistration procedure called preregistration as code (PAC) elsewhere [@peikertReproducibleResearchTutorial2021].
