...
Despite the different names, it is fundamentally the same dichotomy that is at stake here.
 a broad consensus that both approaches are necessary for science to progress; exploration, to make new discoveries and confirmation, to expose these discoveries to potential falsification, and assess empirical support for the theory.
