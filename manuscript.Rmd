...
Specifically, an intuitive conviction is unable to address pragmatic questions, such as what to include, in how much detail in the preregistration, or about the conditions that warrant deviating from it.<!-- Message unclear, if meant like I think: "...such as what to include in the preregistraion and how detailed this should be"-->
...
The exact opposite, preregistered but not strictly confirmatory studies, are also commonplace.
