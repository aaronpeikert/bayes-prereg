...
> *Indented italicized = quote from the revised paper*
...
> We agree that any tool applied thoughtlessly will seldom be effective.
> A clear aim of preregistration could be helpfull to shape its application, especially given that the scientific comunity is still in an experimenting phase around central issues of preregistration, e.g., what level of detail a preregistration should have, under what circumstances to deviate from it, how to review it, or how to deal with exploratory research questions.
...
> To not adequately cite Laken's work was a grave and frankly embarrassing mistake that we regret and did without intention.
> Laken's (and Mayo's) work on severity was at the front of our mind while conceptualising the ideas presented here, so how we missed that we did not explicitly cite them is still baffling to us.
> This mistake can only be explained by us being (wrongly) convinced that we cite them.
...
> What makes the arguments "Bayesian" is what we take probabilities to mean.
...
> We find that it adds value by making an otherwise implicit process explicit to the point of calculatable.
...
> We took considerable time to put what we meant on paper.
...
> For example, a neural network has extreme flexibility in fitting the data closely, yet it is calculatable.
...
> We explicitly consider the whole space of possible measures. From the revised paper:
...
> We included a section called "Hacking, harking, and other harms", which hopefully makes our thinking on these things clearer.
...
> We reference the ideas of frequentist null hypothesis testing to provide readers who are more familiar with this line of reasoning with a better intuition, not to claim equivalent.
...
> We meant "ideal" in the sense of a physicist talking about ideal gas.
...
Sorry for citing myself, no need to cite me - others often make the same points I make, so pointing you to my own papers is mainly just easier for myself. Lakens, D. (2019). The value of preregistration for psychological science: A conceptual analysis. Japanese Psychological Review, 62(3), 221-230. <https://doi.org/10.24602/sjpr.62.3_221> Lakens, D. (2022). Sample Size Justification. Collabra: Psychology, 8(1), 33267. <https://doi.org/10.1525/collabra.33267> Maier, M., & Lakens, D. (2022). Justify Your Alpha: A Primer on Two Practical Approaches. Advances in Methods and Practices in Psychological Science, 5(2), 25152459221080396. <https://doi.org/10.1177/25152459221080396>
Signed,
Daniel Lakens

> Thank you for your review and for allowing us to share it!
