...
> We are sure this is possible and would be enlightening but we would not be sure how to relate the results to the paper.
> The issue is, that how close a theory is to truth, is very difficult to measure.
> That implies that measuring if our approach is successfull is similarly difficult to measure empierically.
> Our goal is more modest: Showing that if you subscribe to a certain class of philosphies of science, you should find preregistered evidence more persuasive.
...
> Applying preregistration with "all the messy details of specific research endeavors" arguably already leads to quite some confusion.
> We hope that some conceptual clarity helps researcher in practice.
> This hope is grounded in Kurt Lewins Maxim: "Nothing as practical as a good theory".
